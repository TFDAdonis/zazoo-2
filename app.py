...
# =============================================================================
# ORIGINAL STREAMLIT APP CODE (FULL VERSION - NO CUTS)
# =============================================================================
...
# Navigation buttons
if st.sidebar.button("🏠 Main Dashboard", use_container_width=True, type="primary"):
    st.session_state.current_page = "Main"

if st.sidebar.button("🌤️ Climate Classifier", use_container_width=True, type="secondary"):
